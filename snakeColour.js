...
while (apfelX < 10 || apfelX >= spielfeld - 10 || apfelY < 10 || apfelY >= spielfeld - 10) {
  apfelX = Math.floor(Math.random() * spielfeld / schritte) * schritte;
  apfelY = Math.floor(Math.random() * spielfeld / schritte) * schritte;
}
